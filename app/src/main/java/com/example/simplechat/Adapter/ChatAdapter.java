...
import com.example.simplechat.MessageModel;
         ...
         holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
             ...
             public boolean onLongClick(View view) {
                 ...
                 new AlertDialog.Builder(context)
                         .setTitle("Delete")
                         .setMessage("Are u sure u want to delete this message")
                         .setPositiveButton("Delete for me only", new DialogInterface.OnClickListener() {
                             @Override
